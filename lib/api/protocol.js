...
var getStrategy = require('../util/get-strategy.js');
...
module.exports = function(Nightwatch) {
  ...
  /**
   *  Simple namespace containing all the protocol actions.
   *  @namespace
   */
  var Actions = {};
  ...
  Actions.element = function(using, value, callback) {
    ...
    if (using == 'auto') {
      var result = getStrategy(value);
      return element(result.using, result.value, callback);
    }
  ...
  Actions.elements = function(using, value, callback) {
    ...
    if (using == 'auto') {
      var result = getStrategy(value);
      return elements(result.using, result.value, callback);
    }
